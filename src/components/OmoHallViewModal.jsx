...
const OmoHallViewModal = ({closeOmoHallViewModal}) => {
    return (
        <div className={modalsstyles.mainContainer} >
            <div className={modalsstyles.ImagesliderContainer}>
                <ImageSlider imageUrls={Images} />
            </div>
            <div className={modalsstyles.closeModalBttn} onClick={() => {closeOmoHallViewModal(false)}}>
                X
            </div>
        </div>
    )
...
export default OmoHallViewModal