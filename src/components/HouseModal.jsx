...
const Images = [House1, PHOTO, PHOTO3, PHOTO4, PHOTO5, PHOTO7, PHOTO8]
...
const HouseModal = ({closeHouseModal}) => {
    ...
    return (
        <div className={modalsstyles.mainContainer} >
            ...
            <div className={modalsstyles.closeModalBttn} onClick={() => {closeHouseModal(false)}}>
                X
            </div>
        </div>
    )
