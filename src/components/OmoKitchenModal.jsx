...
const Images = [PHOTO10, PHOTO5, PHOTO8]
...
const OmoKitchenModal = ({closeOmoKitchenModal}) => {
    return (
        <div className={modalsstyles.mainContainer} >
            <div className={modalsstyles.ImagesliderContainer}>
                <ImageSlider imageUrls={Images} />
            </div>
            <div className={modalsstyles.closeModalBttn} onClick={() => {closeOmoKitchenModal(false)}}>
                X
            </div>
        </div>
    )
...
export default OmoKitchenModal