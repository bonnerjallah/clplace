...
const OmoMasterBedRoomModal = ({closeOmoMasterBedRoomModal}) => {
    ...
    return (
        <div className={modalsstyles.mainContainer} >
            ...
            <div className={modalsstyles.closeModalBttn} onClick={() => {closeOmoMasterBedRoomModal(false)}}>
                X
            </div>
        </div>
    )
...
export default OmoMasterBedRoomModal