...
const OmoDiningRoomModal = ({closeOmoDiningRoomModal}) => {
  return (
    <div className={modalsstyles.mainContainer} >
        <div className={modalsstyles.ImagesliderContainer}>
            <ImageSlider imageUrls={Images} />
        </div>
        <div className={modalsstyles.closeModalBttn} onClick={() => {closeOmoDiningRoomModal(false)}}>
            X
        </div>
    </div>  )
}

export default OmoDiningRoomModal