...
const OmoBedRoomTwoModal = ({closeOmoBedRoomTwoModal}) => {
    return (
        <div className={modalsstyles.mainContainer} >
            <div className={modalsstyles.ImagesliderContainer}>
                <ImageSlider imageUrls={Images} />
            </div>
            <div className={modalsstyles.closeModalBttn} onClick={() => {closeOmoBedRoomTwoModal(false)}}>
                X
            </div>
        </div>
    )
...
export default OmoBedRoomTwoModal